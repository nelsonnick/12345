...
public abstract class BaseFallback<M extends BaseFallback<M>> extends Model<M> implements IBean {
	 ...
	 * 回退原因
	 */
	public void setFallbackReason(java.lang.String fallbackReason) {
		set("fallback_reason", fallbackReason);
	}
	...
	public java.lang.String getFallbackReason() {
		return getStr("fallback_reason");
	}

	/**
	 * 领导意见
	 */
	public void setLeaderOpinions(java.lang.String leaderOpinions) {
		set("leader_opinions", leaderOpinions);
	}
	
	/**
	 * 领导意见
	 */
	public java.lang.String getLeaderOpinions() {
		return getStr("leader_opinions");
	}
	...
	public java.lang.String getSuggestion() {
		return getStr("suggestion");
	}

	/**
	 * 回退部门
	 */
	public void setFallbackDepartment(java.lang.String fallbackDepartment) {
		set("fallback_department", fallbackDepartment);
	}
	
	/**
	 * 回退部门
	 */
	public java.lang.String getFallbackDepartment() {
		return getStr("fallback_department");
	}

	/**
	 * 回退时间
	 */
	public void setFallbackTime(java.lang.String fallbackTime) {
		set("fallback_time", fallbackTime);
	}
	
	/**
	 * 回退时间
	 */
	public java.lang.String getFallbackTime() {
		return getStr("fallback_time");
	}

	/**
	 * 回退人
	 */
	public void setFallbackPerson(java.lang.String fallbackPerson) {
		set("fallback_person", fallbackPerson);
	}
	
	/**
	 * 回退人
	 */
	public java.lang.String getFallbackPerson() {
		return getStr("fallback_person");
	}

	/**
	 * 回退联系电话
	 */
	public void setFallbackPhone(java.lang.String fallbackPhone) {
		set("fallback_phone", fallbackPhone);
	}
	
	/**
	 * 回退联系电话
	 */
	public java.lang.String getFallbackPhone() {
		return getStr("fallback_phone");
	}
