...
public class MainController extends Controller {
    ...
    public void b(){
        ...
        for (int i = 0; i < trs.size() - 1; i++) {
            ...
            if (service2.findNumByGUID(order_guid)==0){
                String urls = "http://15.1.0.24/jhoa_huaiyinqu/taskhotline/ViewTaskHotLine.aspx?GUID=" + order_guid + "&IsZDDB=&";
