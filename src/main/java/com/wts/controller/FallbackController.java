...
//        }
	...
	//    第1页用这个
	public void getPageFirst(String cookie){
...
//                .set("new_supervision",new_supervision)
	...
	// 第二页用这个
	public static void getPageSecond(String cookie){
		String pageUrl = util12345.getPageUrl("2");
		String referer = "http://15.1.0.24/jhoa_huaiyinqu/taskhotline/listTaskHotLine.aspx?MessageType=202&issend=1";
		getPage(cookie,pageUrl,referer);
	}
	// 其他页用这个
	public static void getPageOther(Integer pageNum, String cookie){
		String pageUrl = util12345.getPageUrl(pageNum + "");
		String referer = util12345.getPageUrl(pageNum - 1 + "");
		getPage(cookie,pageUrl,referer);
	}

	//   分页信息下载
	public static void getPage(String cookie, String pageUrl, String referer) {
		System.out.println(pageUrl);
		Document doc = getDoc(pageUrl, cookie, referer);
...
//		}
	...
	//    2页以后用这个--->有问题
	public static void getPage2(Integer pageNum, String cookie) {
		System.out.println(pageNum);
//		Document doc = getDoc2(pageNum+"", cookie, "202");
		Document doc = getPageInfo(pageNum+"", cookie, "202");
...
//		}
	...
	public static void main(String[] args) {
		String cookie = PropKit.use("config-dev.txt").get("cookie");
//		getPageSecond(cookie);
		getPageOther(3,cookie);
	}
}
